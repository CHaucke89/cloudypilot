...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CompletedSunnylinkConsentVersion", {PERSISTENT, STRING, "1.0"}},
    ...
    {"HasAcceptedTermsSP", {PERSISTENT, STRING, "1.0"}},
    ...
    {"HyundaiRadar", {PERSISTENT | BACKUP, INT, "1"}},
    ...
    {"CustomKp", {PERSISTENT | BACKUP, FLOAT, "0.8"}},
    {"CustomKi", {PERSISTENT | BACKUP, FLOAT, "0.15"}},
